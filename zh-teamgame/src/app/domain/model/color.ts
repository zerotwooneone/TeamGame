...
export enum ColorFilter {
    Red = "invert(17%) sepia(93%) saturate(6389%) hue-rotate(358deg) brightness(104%) contrast(119%)",
    Orange = "invert(66%) sepia(86%) saturate(2871%) hue-rotate(0deg) brightness(102%) contrast(105%)",
    Yellow = "invert(87%) sepia(82%) saturate(2327%) hue-rotate(359deg) brightness(107%) contrast(104%)",
    Green = "invert(66%) sepia(72%) saturate(4610%) hue-rotate(85deg) brightness(115%) contrast(133%)",
    Blue = "invert(8%) sepia(93%) saturate(7493%) hue-rotate(247deg) brightness(99%) contrast(143%)",
    Aqua = "invert(84%) sepia(99%) saturate(1912%) hue-rotate(107deg) brightness(103%) contrast(104%;",
    Indigo = "invert(28%) sepia(97%) saturate(7368%) hue-rotate(315deg) brightness(100%) contrast(109%;",
    Violet = "invert(9%) sepia(100%) saturate(6767%) hue-rotate(277deg) brightness(112%) contrast(117%;",
    Magenta = "invert(22%) sepia(88%) saturate(4704%) hue-rotate(292deg) brightness(109%) contrast(129%;"
}
export class Color {
